...
declare namespace Cypress {
  interface Chainer<Subject> {
    /**
       ...
       */
    (
      chainer: "have.computedStyles",
      expectedStyles: object
    ): Chainable<Subject>;
    ...
    /**
       ...
       */
    (
      chainer: "have.distanceBetweenEdges",
      $secondElement: JQuery,
      firstElementEdge: string,
      secondElementEdge: string,
      distance: number,
      tolerance?: number
    ): Chainable<Subject>;
    ...
    /**
       ...
       *
       */
    (chainer: "be.sameWidthAs", $secondElement: JQuery): Chainable<Subject>;
  }
}
